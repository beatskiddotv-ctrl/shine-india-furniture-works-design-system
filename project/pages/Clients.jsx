...
const ClientsPage = ({ navigate }) => {
  ...
  const projects = [
    { img: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1200&q=80", title: "Tech Co. Bengaluru HQ", scale: "320 workstations · 12 conference rooms", year: "2025" },
    { img: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1200&q=80", title: "Boutique Hotel Goa", scale: "48 rooms · custom hospitality fit-out", year: "2025" },
    { img: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=1200&q=80", title: "Residential — Whitefield", scale: "Full home install · 4BHK luxury", year: "2024" },
    { img: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=1200&q=80", title: "Govt. Institution Bhopal", scale: "Library & hostel · 220 units", year: "2024" },
  ];
  ...
  return (
    <main>
      <PageHero
        ...
        image="https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=2200&q=80"
