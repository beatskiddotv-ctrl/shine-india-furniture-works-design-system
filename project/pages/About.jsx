      ...
      <section className="section about-story">
        <div className="container story-grid">
          <div className="story-img-stack">
            <img className="story-img-1" src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=900&q=80" alt="Furniture craftsmanship" loading="lazy" />
            <img className="story-img-2" src="https://images.unsplash.com/photo-1604079628040-94301bb21b91?auto=format&fit=crop&w=600&q=80" alt="Team at work" loading="lazy" />
          ...
          <div className="founders-grid">
            <article className="founder-card">
              <div className="founder-photo">
                <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=800&q=80" alt="Krishna Singh" loading="lazy" />
            ...
            <article className="founder-card">
              <div className="founder-photo">
                <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=800&q=80" alt="Alok Singh" loading="lazy" />
