  ...
  return (
    <section ref={heroRef} className="hero">
      <div
        ...
        style={{
          backgroundImage:
            `linear-gradient(95deg, rgba(11,18,36,0.85) 0%, rgba(11,18,36,0.55) 55%, rgba(11,18,36,0.35) 100%), url('${window.__resources["img40"]}')`,
        ...
        <div className="hero-card glass">
          <div className="hero-card-row">
            <div className="hero-card-avatars">
              {["img7","img5","img6"].map((__id, __i) => (
                <span key={__i} className="avatar" style={{
                  backgroundImage: `url(${window.__resources[__id]})`
                }} />
              ))}
            </div>
