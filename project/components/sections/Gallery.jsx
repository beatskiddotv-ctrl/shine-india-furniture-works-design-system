...
const Gallery = () => {
  const images = [
    { src: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=900&q=80", title: "Living room install", category: "Residential" },
    { src: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1200&q=80", title: "Corporate fit-out", category: "Office" },
    { src: "https://images.unsplash.com/photo-1631889993959-41b4e9c6e3c5?auto=format&fit=crop&w=900&q=80", title: "Hydraulic bed setup", category: "Residential" },
    { src: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=1200&q=80", title: "Sliding wardrobe", category: "Residential" },
    { src: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=900&q=80", title: "Kitchen cabinets", category: "Residential" },
    { src: "https://images.unsplash.com/photo-1604079628040-94301bb21b91?auto=format&fit=crop&w=900&q=80", title: "Team at work", category: "Behind the scenes" },
    { src: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1200&q=80", title: "Reception desk install", category: "Office" },
    { src: "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?auto=format&fit=crop&w=900&q=80", title: "Designer chair assembly", category: "Residential" },
  ];
