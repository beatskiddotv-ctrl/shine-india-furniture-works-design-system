  ...
  return (
    <section className="cta-banner">
      <div
        ...
        style={{
          backgroundImage:
            `linear-gradient(105deg, rgba(11,18,36,0.92) 30%, rgba(11,18,36,0.6)), url('https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=2200&q=80')`
        }}
      />
